...
namespace Eren_Pansiyon_Uygulaması_V1
{
    public partial class FrmYeniMusteri : Form
    {
        ...
        {
            int ucret;
            // Giriş ve çıkış tarihleri DateTime türüne dönüştürülüyor.
            DateTime KucukTarih = Convert.ToDateTime(DtpGirisTarihi.Text);
            DateTime BuyukTarih = Convert.ToDateTime(DtpCikisTarihi.Text);
            // İki tarih arasındaki gün farkı hesaplanıyor.

            TimeSpan Sonuc;
            Sonuc=  BuyukTarih - KucukTarih;

            TxtUcret.Text = Sonuc.TotalDays.ToString();
            ucret = Convert.ToInt32(TxtUcret.Text) * 50;     // Konaklama süresi ile belirlenen birim fiyat (50 birim) çarpılarak toplam ücret hesaplanıyor.
            TxtUcret.Text = ucret.ToString();      // Hesaplanan toplam ücret TextBox'e yazdırılıyor.
        ...
        private void FrmYeniMusteri_Load(object sender, EventArgs e)
        {
            ...
            while (oku9.Read())
            {
               ...
               // BtnOda109.Text = oku1["Adi"].ToString() + " " + oku9["Soyadi"].ToString();
            }
            baglanti.Close();
